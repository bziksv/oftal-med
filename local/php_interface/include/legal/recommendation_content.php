...
<div class="legal-doc">
    ...
    <p>9. Настоящие Правила действуют бессрочно до замены новой версией. Актуальная редакция размещается на Сайте по адресу <?= legal_doc_internal_link($legal, 'recommendation') ?>.</p>

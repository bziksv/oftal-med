...
$APPLICATION->SetPageProperty("description", "Каталог товаров на сайте офтальмологического оборудования и приборов оптом и в розницу с заводов-производителей");
$APPLICATION->SetTitle("Медицинская техника oftal-med.ru -прямые поставки от производителей");
?><div class="wrapper">
	 <?

...
$APPLICATION->SetPageProperty("description", "Поставки офтальмологического оборудования и приборов оптом и в розницу с заводов-производителей. Проконсультируем по всем вопросам");
$APPLICATION->SetPageProperty("title", "Инструменты и приборы на oftal-med.ru от производителей - интернет магазин с доставкой по РФ");
$APPLICATION->SetTitle("oftal-med.ru - поставки медицинской техники от производителей по всей России");
...
<div class="container">
			...
			<div class="categories">
				 <? if(isset($arHomeSectionFour)): ?> <?
                        ...
                        unset($arHomeSection[$del]);
                            ?> <a href="<?=$section['SECTION_PAGE_URL']?>" class="categories__item"> <span class="categories__item_wrapper"> <span class="categories__img"><img alt="categories" src="<?=$section['PICTURE']?>"></span> <span class="categories__title"><?=$section['NAME']?></span> </span> </a>
				<?endforeach;?> <? endif; ?>
			</div>
	...
	Array(
		...
		"STRICT_SECTION_CHECK" => "N"
			...
			<div class="categories">
				 <? if(isset($arHomeSection)): ?> <? foreach($arHomeSection as $section): ?> <a href="<?=$section['SECTION_PAGE_URL']?>" class="categories__item"> <span class="categories__item_wrapper"> <span class="categories__img"><img alt="categories" src="<?=$section['PICTURE']?>"></span> <span class="categories__title"><?=$section['NAME']?></span> </span> </a>
				<?endforeach;?> <? endif; ?>
			</div>
			<hr class="hr">
			<div class="title">
				 Новинки офтальмологического оборудования
			</div>
			<div class="goods">
				 <?$APPLICATION->IncludeComponent(
	"bitrix:news.line",
	...
	Array(
		...
		"SORT_ORDER2" => "DESC"
			...
			<div class="title">
				 Лучшие предложения на <?=EditData(date("d.m.Y"))?>
			</div>
			<div class="goods">
				 <?

...
if($result["action"] == 'image-request'){
	...
	if($data['error_message']){
		...
		$result['renew_request'] = $data['renew_request'];
...
if($result["action"] == 'create_element_text'){
	...
	$params = [
		...
		'template_image' => htmlspecialcharsbx($_POST['template_image']),
		'size' => htmlspecialcharsbx($_POST['size']),
...
if($result["action"] == 'mass_create_elements'){
	...
	if(!$result['error_message']){
		...
		if($res['error_message']){
			...
			$result['renew_request'] = $res['renew_request'];
			...
			$result['token_price'] = Tools::getTokenPrice($params['provider']);

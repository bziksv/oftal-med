    ...
    <div class="container">
        <div class="footer__row">
            ...
            <div class="footer__col flex-2">
                ...
                <a href="https://prime-ltd.su/?from=oftal-med.ru" target="_blank" rel="nofollow">
		...
		<?php
		$oftalMedLegal = include $_SERVER['DOCUMENT_ROOT'] . '/local/php_interface/include/legal/config.php';
		$legalUrls = $oftalMedLegal['images'];
		?>
		<div><noindex>Вся информация, представленная на данном сайте, носит исключительно ознакомительный характер и не является публичной офертой. Мы используем файлы <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['cookie']) ?>">cookies</a> для улучшения удобства пользования сайтом, настройки рекламных материалов и анализа посещаемости. Продолжая использовать сайт, вы даёте <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['consent']) ?>">согласие на обработку персональных данных</a> и соглашаетесь с <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['personal_data']) ?>">Политикой обработки персональных данных</a>. Для отказа от обработки cookies можно отключить сохранение cookies в настройках вашего браузера. На сайте также применяются <a target="_blank" rel="nofollow noopener" style="color: #fff;" href="<?= htmlspecialcharsbx($legalUrls['recommendation']) ?>">рекомендательные технологии</a>.</noindex></div>
    </div>
</div>

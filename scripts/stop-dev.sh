...
lsof -ti:8101 2>/dev/null | xargs kill 2>/dev/null || true
lsof -ti:9101 2>/dev/null | xargs kill 2>/dev/null || true
...
sleep 1
lsof -ti:8101 2>/dev/null | xargs kill -9 2>/dev/null || true
lsof -ti:9101 2>/dev/null | xargs kill -9 2>/dev/null || true

echo "stopped (:8101 / :9101)"

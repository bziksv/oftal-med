 ...
 *   BASE_URL=http://127.0.0.1:8101 node scripts/generate-legal-images.mjs
 */
...
const baseUrl = (process.env.BASE_URL || 'http://127.0.0.1:8101').replace(/\/$/, '');
const uploadDir = path.join(projectRoot, 'upload');

const documents = [
    {
        slug: 'oftal-med-personal-data-consent',
        fileName: 'soglasie-na-obrabotku-personalnyh-dannyh-oftalmed.jpg',
    },
    {
        slug: 'oftal-med-personal-data-policy',
        fileName: 'politics.jpg',
    },
    {
        slug: 'oftal-med-cookie-policy',
        fileName: 'politika-ispolzovanija-cookies-oftalmed.jpg',
    },
    {
        slug: 'oftal-med-recommendation-rules',
        fileName: 'rules-recommendation.jpg',
    },
];
